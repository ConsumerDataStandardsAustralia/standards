...
./oas_generate.sh api/cds_banking_non_bank_lending.json openapi json ../slate/source/includes/swagger
./oas_generate.sh api/cds_banking_dp306.json openapi json ../slate/source/includes/swagger
...
./oas_generate.sh api/cds_register_banking_non_bank_lending.json openapi json ../slate/source/includes/swagger
./oas_generate.sh api/cds_dcr.json openapi json ../slate/source/includes/swagger
./oas_generate.sh api/cds_telco.json openapi json ../slate/source/includes/swagger
