...
sed -i  '/consumer-data-standards-administration-end-points-admin-apis/d' cds_admin.md
sed -i  's/# Schemas/## Schemas/g' cds_admin.md
sed -i  's/This operation does not require authentication/This operation may only be called by the CDR Register/g' cds_admin.md
