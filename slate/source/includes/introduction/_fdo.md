...
|[Authentication Flows](#authentication-flows)|Data Holders **SHALL** only support Authorisation Code Flow from **May 12th 2025**. Data Recipients **SHALL** only send authorisation requests using Authorisation Code Flow from this date. | May 12th 2025 |