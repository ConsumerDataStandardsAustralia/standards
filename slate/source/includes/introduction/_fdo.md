...
|[Shared Responsibility -> Energy -> Additional Requirements](#additional-requirements)| Additional requirements for sharing electricity usage data according to Last Consumer Change Date (LCCD) **MUST** be supported by energy data holders by **November 10th 2025** | November 10th 2025 |
