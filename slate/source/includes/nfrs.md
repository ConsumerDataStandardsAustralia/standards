...
|High Priority|**1000ms**|The following Unauthenticated end points:<ul><li>Get Status</li><li>Get Outages</li></ul>Customer Present calls to the following end points:<ul><li>InfoSec end points</li><li>CDR Arrangement Revocation</li><li>Get Accounts</li><li>Get Customer</li><li>Get Customer Detail</li></ul>|
...
|Unattended|**4000ms**|Unattended calls to the following end points that are not Large Payload end points:<ul><li>High Priority Authenticated end points</li><li>Low Priority Authenticated end points</li><li>InfoSec end points</li><li>CDR Arrangement Revocation</li><li>Admin end points.</li></ul>Dynamic Client Registration end points.|
|Large Payload|**6000ms**|Any Unattended calls to the following end points:<ul><li>Get Transactions For Account</li><li>Get Bulk Direct Debits</li><li>Get Direct Debits For Specific Accounts</li><li>Get Scheduled Payments Bulk</li></li><li>Get Scheduled Payments For Specific Accounts</li></ul>|
