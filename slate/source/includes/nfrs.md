...
|High Priority|**1000ms**|Customer Present calls to the following end points:<ul><li>InfoSec end points</li><li>Get Accounts</li><li>Get Customer</li><li>Get Customer Detail</li></ul>|
...
|Unattended|**4000ms**|Unattended calls to High Priority or Low Priority authenticated end points.</br>Additional Admin end points.|
