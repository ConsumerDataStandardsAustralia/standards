...
|**Contact Details**|Phone;<br>Email address;<br>Mail address;<br>Residential address;|common:customer.detail:read|
|**Name, contact details &Dagger;**|Name;<br>Phone;<br>Email address;<br>Mail address;<br>Residential address;|common:customer.detail:read|
...
### Energy Accounts
The below tables outline the data language standards for the energy accounts scopes:
...
### Concessions
The below tables outline the data language standards for the concession scope:
...
### Payments
The below tables outline the data language standards for the payments schedule scope:
...
### Billing
The below tables outline the data language standards for the billing scope:
...
The below tables outline the data language standards for the Distributed Energy Resources (DER) scope:
