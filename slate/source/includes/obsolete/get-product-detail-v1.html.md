...
|x-v|header|string|mandatory|Version of the API end point requested by the client. Must be set to a positive integer. The data holder should respond with the highest supported version between [x-min-v](../../index.html#request-headers) and [x-v](../../index.html#request-headers). If the value of [x-min-v](../../index.html#request-headers) is equal to or higher than the value of [x-v](../../index.html#request-headers) then the [x-min-v](../../index.html#request-headers) header should be treated as absent. If all versions requested are not supported then the data holder should respond with a 406 Not Acceptable. See [HTTP Headers](../../index.html#request-headers)|
...
|---|---|---|---|---|
|200|x-v|string||The [version](../../index.html#response-headers) of the API end point that the data holder has responded with.|
...
|additionalInfoUri|[URIString](../../index.html#common-field-types)|optional|none|Link to a web page with more information on this condition|
...
|productCategory|[BankingProductCategory](#schemabankingproductcategory)|mandatory|none|The category to which a product or account belongs. See [here](../../index.html#product-categories) for more details|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|*anonymous*|string|optional|none|The category to which a product or account belongs. See [here](../../index.html#product-categories) for more details|
