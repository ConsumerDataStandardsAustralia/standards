...
|Large Payload|**6000ms**|Any calls to the following end points:<ul>*Banking*<li>Get Bulk Direct Debits</li><li>Get Direct Debits For Specific Accounts</li><br>*Energy*<li>Get Bulk Billing</li><li>Get Billing For Specific Accounts</li></ul>|
