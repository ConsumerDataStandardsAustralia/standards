...
|-----------|-------|-----------|----------------|
|TBC| 1.25.0 | Changes arising from Decision TBC (Maintenance iteration 15) and Decision 288 (Metrics and NFRs) | See [release notes](includes/releasenotes/releasenotes.1.25.0.html), [Decision TBC](https://github.com/ConsumerDataStandardsAustralia/standards/issues/TBC) and [Decision 288](https://github.com/ConsumerDataStandardsAustralia/standards/issues/288) for details. |
