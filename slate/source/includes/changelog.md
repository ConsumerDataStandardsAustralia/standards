...
|-----------|-------|-----------|----------------|
|11/08/2022| 1.18.0 | Maintenance Iteration 11 | Changes included in [Decision 249 - Maintenance Iteration 11](https://github.com/ConsumerDataStandardsAustralia/standards/issues/249). See [release notes](includes/releasenotes/releasenotes.1.18.0.html) for details | 
