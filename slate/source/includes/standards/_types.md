...
ExternalRefString | The format is defined by an external reference such as ISO standard or an RFC | Swift bank codes using [ISO 9362](https://www.iso.org/standard/60390.html)
