...
**x-cds-User-Agent** | The customer's original User Agent header if the customer is currently logged in to the data recipient. Mandatory for customer present calls.  Not required for unattended or unauthenticated calls. [Base64](#common-field-types) encoded contents with may include additional parameters.| Conditional
